<?php
    ...
    $stmt = $pdo->prepare("SELECT * FROM maestro_details where art_form = :art_form");
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="NavBar">
                    <ul class="navbar-nav mr-auto">
                        ...
                        <li class="nav-item"><a class="nav-link" href="#">View Maestro</a></li>
        ...
        <div class="container">
            <div class="row">
                <div class="col-12">
                    ...
                    ?>
                    <h3>Here is the list of Maestros in your Art Form</h3>
                    <div class="box-container">
                        <?php
                            foreach ($rowsofart as $row) {
                                ...
                                echo($row['city'].'<br/>');
                                echo($row['country'].'<br/>');
                                echo('<a href="profile_view.php?email=' . $row['email'] . '">More Details</a>');
                                echo('</div>');
                            } 
                        ?>
                    </div>
